...
simulation <- function(num_groups, num_cells, num_genes, de_prob, seed, cores, shared_memory_max) {
  ...
  recall_NB_copula_memory <- peakRAM::peakRAM({
    recall_nb_copula_seurat_obj <- FindClustersCallback(seurat_obj, null_method = "NB-copula", cores = cores, shared_memory_max = shared_memory_max)
  })$Peak_RAM_Used_MiB
  ...
  recall_zip_seurat_obj <- FindClustersCallback(seurat_obj, null_method = "ZIP", cores = cores, shared_memory_max = shared_memory_max)
  })$Peak_RAM_Used_MiB
  ...
  recall_nb_seurat_obj <- FindClustersCallback(seurat_obj, null_method = "NB", cores = cores, shared_memory_max = shared_memory_max) #,resolution_start = 2.4)
  })$Peak_RAM_Used_MiB
  ...
  recall_poisson_copula_seurat_obj <- FindClustersCallback(seurat_obj, null_method = "Poisson-copula", cores = cores, shared_memory_max = shared_memory_max)
  })$Peak_RAM_Used_MiB
  recall_Poisson_copula_end_time <- Sys.time()
  
  #print("running recall Gaussian-copula")
  #recall_gaussian_copula_seurat_obj <- FindClustersCallback(seurat_obj, null_method = "Gaussian-copula", cores = cores)
  ...
  seurat_obj[["recall_ZIP"]] <- recall_zip_seurat_obj@meta.data$callback_clusters
  seurat_obj[["recall_NB"]] <- recall_nb_seurat_obj@meta.data$callback_clusters
  seurat_obj[["recall_NB-copula"]] <- recall_nb_copula_seurat_obj@meta.data$callback_clusters
  seurat_obj[["recall_Poisson-copula"]] <- recall_poisson_copula_seurat_obj@meta.data$callback_clusters
  #seurat_obj[["recall_Gaussian-copula"]] <- recall_gaussian_copula_seurat_obj@meta.data$callback_clusters
  
  seurat_obj[["recall_countsplit"]] <- countsplit_seurat_obj@meta.data$callback_clusters
...
for (replicate in 1:num_replicates) {
  ...
  cluster_metrics_df <- rbind(cluster_metrics_df,
                              ...
                              #recall_Gaussian_copula_metrics_df_row,
